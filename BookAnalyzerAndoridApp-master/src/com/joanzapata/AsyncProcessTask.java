...
private final PDFViewActivity activity;
	public AsyncProcessTask(byte[] data, PDFViewActivity activity) {
	...
	//	String inputFile = args[0];
		...
		try {
			...
			*/
			Task task = restClient.processImage(data, processingSettings);
